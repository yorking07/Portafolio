  ...
  return (
    <article className="portafolio__article">
      ...
      <section className="portafolio__setcion2">
        ...
        <a className="portafolio__desplegable" href="https://galleta-de-la-fortuna-five.vercel.app/" target="_blank">
          <img className="portafolio__icono" src="https://cdn-icons-png.flaticon.com/128/3113/3113022.png" alt="" />
        </a>
      </section>
    </article>
  );
